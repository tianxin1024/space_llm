...
private:
    ...
    Embedding(int dim_model, int vocab_size, bool scale_weights = false) :
...
public:
    ...
    static Embedding create(int dim_model, int vocab_size, bool scale_weights = false) {
        auto embedding = Embedding(dim_model, vocab_size, scale_weights);
        return embedding;
    }
