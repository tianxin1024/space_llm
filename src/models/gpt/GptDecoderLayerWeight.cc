...
template <typename T>
GptDecoderLayerWeight<T>::GptDecoderLayerWeight(const int int8_mode) :
    int8_mode_(int8_mode) {
}

template <typename T>
GptDecoderLayerWeight<T>::GptDecoderLayerWeight(const int hidden_units,
...
template <typename T>
void GptDecoderLayerWeight<T>::copyFrom(const GptDecoderLayerWeight &other) {
...
template <typename T>
void GptDecoderLayerWeight<T>::loadModel(std::string dir_path, QKCudaDataType model_file_type) {
